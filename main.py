...
def color_calendar(year):
    ...
    for month in range(12):
        ...
        month_nam = calendar.month_name[month+1]

        table = Table(title=f"[bold cyan]{month_nam}  [bold cyan]{year}", show_lines=True)
        ...
        table.add_column("Sat", justify="center", style="blue")
